...
void plannerSubmenu_cb(int plannerStateIn); //planner state menu callback
void missionControl_cb(int missionStateIn);
...
class glutVizualisation
{
    ...
    public:
        ...
        void setPlanner(Planner* plannerIn);
        void setDrawOffset(double offset_x, double offset_y);
        void setMissionHandler(MissionHandler *missionHandler_in);
